...
struct UserProfileView: View {
    ...
    @State var username = ""
    @State var isShowingAlertExistUsername = false
        ...
        VStack {
            ...
            VStack {
                HStack {
                    ...
                    Button {
                        ...
                        Button("OK", action: {
                            ...
                            Task {
                                ...
                                if isValid == false {
                                    isShowingAlertExistUsername = true
                                    username = LoginViewModel.shared.userLogin?.username ?? "Anonymous"
                                }
                            }
                        })
                    ...
                    .alert(isPresented: $isShowingAlertExistUsername) {
                        Alert(
                                    title: Text("Warning"),
